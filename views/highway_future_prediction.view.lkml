view: highway_future_prediction {
  sql_table_name: `mi-dept-of-transportation.MDOT_Processed.highway_future_prediction`
    ;;
  ...
  dimension: count_highway_future_prediction {
    type: number
    sql: ${TABLE}.count ;;
    hidden: yes
  }
  ...
  measure: predicted_highway_crash {
    type: sum
    sql: ${TABLE}.predicted_crash_count ;;
  }
